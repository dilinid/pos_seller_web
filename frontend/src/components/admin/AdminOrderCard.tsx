...
export const AdminOrderCard: React.FC<AdminOrderCardProps> = ({ order, deliveryMethod, onClick }) => {
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '10px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
          <OrderStatusBadge status={items[0]?.status ?? 'pending'} deliveryMethod={deliveryMethod} />
