  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '20px' }}>
        ...
        <button onClick={() => navigate('/admin/products/add')} className="btn btn-primary" style={{ padding: '10px 20px', borderRadius: '10px', fontSize: '0.85rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
      ...
      {filtered.length === 0 ? (
        <div className="pos-empty" style={{ marginTop: '24px' }}>
          ...
          {activeTab === 'all' && (
            <button onClick={() => navigate('/admin/products/add')} className="btn btn-primary" style={{ padding: '10px 24px', borderRadius: '24px', fontSize: '0.85rem' }}>
              Add Product
            </button>
          )}
        </div>
