...
export const dashboardContacts: Record<string, DashboardContactInfo> = {
  aib: {
    ...
    socials: [
      { label: 'Facebook', href: 'https://www.facebook.com/', icon: <FaFacebook size={14} />, value: 'facebook' },
      { label: 'YouTube', href: 'https://www.youtube.com/', icon: <FaYoutube size={14} />, value: 'youtube' },
      { label: 'Instagram', href: 'https://www.instagram.com/', icon: <FaInstagram size={14} />, value: 'instagram' },
      { label: 'Web', href: '#', icon: <Globe size={14} />, value: 'web' },
    ],
  },
  apex: {
